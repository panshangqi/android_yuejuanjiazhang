...
import icon_zhouce from '@imgs/zhouce_corner.png'
...
class PageHeader extends Component {
    ...
    onMinWindow(){
        YQ.http.get(YQ.util.make_local_url('/window_frame'),{mini: true},function () {
    ...
    onMaxiWindow(){
        ...
        // }
        YQ.http.get(YQ.util.make_local_url('/window_frame'),{maxi: true},function (res) {

            if(res && res.data.op == 'maxi'){
                console.log(res.data)
                This.setState({maxwindow: res.data.isMax});
            }
        })
    }
    onCloseWindow(){
        YQ.http.get(YQ.util.make_local_url('/window_frame'),{close: true},function () {
    ...
    render() {
        return (
            <div className="page_head">
                <div className="test_env_box" style={{display: YQ.config.isTestENV? 'block': 'none'}}><Tag color="green" style={{}}>测试环境</Tag></div>
                <AboutInfo ref="about_dlg" />
                <DriveSetting ref="drive_dlg" />
                <DirectorySetting ref="directory_dlg"/>
                <div className="app_logo">
                    <img src={icon_zhouce} style={{width:70}}/>
                    <img src={icon_logo} style={{width:130}}/>
                </div>
                <div className="windows_btns">
                    ...
                    <div className="win_btn">
                        <img src={icon_close} onClick={this.onMinWindow}/>
                    </div>
                </div>
